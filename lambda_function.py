...
def handler(event, context):
    ...
    # 3.0 Load both csv and json files
    ...
    # 3.1 Using the dataframe from the population data API (Part 2), 
    # generate the mean and the standard deviation of the annual US population 
    # across the years [2013, 2018] inclusive.
    ...
    # 3.2 Using the dataframe from the time-series (Part 1), For every series_id,
    ...
    ### 3.3 Using both dataframes from Part 1 and Part 2, 
    # generate a report that will provide the value for series_id = PRS30006032 
    # and period = Q01 and the population for that given year 
    ...
    logger.info(
        """The report that will provide the value for series_id = PRS30006032 
        and period = Q01 and the population for that given year"""
    )
